...
import './HomePage.css';
import Team from './Primary/Team';
import OneOnOnes from './Primary/OneonOneSchedule';
import Projects from './Primary/Projects';
import Tasks from './Primary/Tasks';
import ProfileMenu from './Primary/ProfileMenu';

const tabs = ['My Team', '1:1s', 'Projects', 'Tasks'];

const tabTitles: { [key: string]: string } = {
    'My Team': 'Team Members',
    '1:1s': 'One on One Schedule',
    'Projects': 'Projects',
    'Tasks': 'Task List',
};
...
const HomePage: React.FC = () => {
    ...
    const handleLogout = () => {
        // Implement logout logic here, for now just redirect to login
    ...
    return (
        <div className="home-page">
            ...
            <div className="tab-title-container">
                <span className="tab-title">{tabTitles[activeTab]}</span>
            </div>
