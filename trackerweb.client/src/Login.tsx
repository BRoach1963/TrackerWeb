...
const Login: React.FC<LoginProps> = ({ onLogin, onCreateAccount}) => {
    ...
    const handleLogin = () => {
        // Since no validation is required, simply call the onLogin callback
        onLogin();
    };
    ...
    return (
        <div style={{ textAlign: 'center', marginTop: '50px' }}>
            ...
            <div className="create-account-link">
                <p>No account? <span onClick={onCreateAccount} style={{ color: 'blue', cursor: 'pointer' }}>Click to create an account</span></p>
            </div>
        </div>
    );
}
